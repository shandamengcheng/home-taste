...
Page({
  ...
  async save() { this.setData({saving:true}); try { await call('saveSelection',{date:this.data.date,dishIds:this.data.selectedIds}); wx.showToast({title:'我的选择已同步'});setTimeout(()=>wx.navigateBack(),500) } catch(_){} finally { this.setData({saving:false}) } }
})
